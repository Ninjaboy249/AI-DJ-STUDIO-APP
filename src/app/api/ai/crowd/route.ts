// /api/ai/crowd — POST
// LangChain chain for crowd mood detection from simulated sensor readings.
...
faceCount: ${reading.faceCount} people`;
    ...
    const model = new ChatGroq({ apiKey, model: 'llama-3.3-70b-versatile', temperature: 0.4, maxTokens: 700 });
